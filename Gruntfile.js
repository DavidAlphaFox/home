  ...
  module.exports = function(grunt) {
    grunt.initConfig({
      ...
      concat: {
        ...
        css: {
          src: ['bower_components/bootstrap/dist/bootstrap.css', 'bower_components/bootstrap/dist/bootstrap-theme.css', 'stylesheets/style.css'],
          dest: 'dist/app.css'
        }
      },
      uglify: {
    ...
    return grunt.registerTask('default', ['concat', 'uglify', 'cssmin']);
  };
